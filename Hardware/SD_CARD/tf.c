...
SD_Error SD_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11; 	//PC8,9,10,11,12复用功能输出	
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;//复用功能
	GPIO_InitStructure.GPIO_Speed = GPIO_High_Speed;//100M
	...
	NVIC_InitStructure.NVIC_IRQChannel = SDIO_IRQn;         //IRQ通道使能
...
SD_Error SD_PowerON(void)
{
	...
	SDIO->CLKCR|=SDIO_CLKCR_CLKEN;			//SDIOCK使能  
