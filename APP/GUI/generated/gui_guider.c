...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->software_screen_del = true;
    ui->calendar_screen_del = true;
    ui->calculate_screen_del = true;
    ui->peripheral_screen_del = true;
    ui->weather_screen_del = true;
    ui->alarm_screen_del = true;
    ui->alarm_set_screen_del = true;
}
...
void init_keyboard(lv_ui *ui)
{
	...
	lv_obj_set_style_text_font(ui->g_kb_top_layer, &lv_font_montserrat_14, LV_PART_MAIN|LV_STATE_DEFAULT);
