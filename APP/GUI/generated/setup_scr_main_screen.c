...
void setup_scr_main_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->main_screen_week_label, 69, 63);
    ...
    // Write codes main_screen_ararm_cont
    ui->main_screen_ararm_cont = lv_obj_create(ui->main_screen_cont_1);
    lv_obj_set_pos(ui->main_screen_ararm_cont, 10, 80);
    lv_obj_set_size(ui->main_screen_ararm_cont, 300, 100);
    lv_obj_set_scrollbar_mode(ui->main_screen_ararm_cont, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->main_screen_ararm_cont, LV_OBJ_FLAG_HIDDEN);

    // Write style for main_screen_ararm_cont, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->main_screen_ararm_cont, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->main_screen_ararm_cont, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->main_screen_ararm_cont, lv_color_hex(0xdbd0d0), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->main_screen_ararm_cont, LV_BORDER_SIDE_FULL, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->main_screen_ararm_cont, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->main_screen_ararm_cont, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->main_screen_ararm_cont, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->main_screen_ararm_cont, LV_GRAD_DIR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->main_screen_ararm_cont, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->main_screen_ararm_cont, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->main_screen_ararm_cont, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->main_screen_ararm_cont, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->main_screen_ararm_cont, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes main_screen_ararm_cancel_imgbtn
    ui->main_screen_ararm_cancel_imgbtn = lv_imgbtn_create(ui->main_screen_ararm_cont);
    lv_imgbtn_set_src(ui->main_screen_ararm_cancel_imgbtn, LV_IMGBTN_STATE_RELEASED, NULL, "0:/PICTURE/software_icon/cancel_icon.bin", NULL);
    ui->main_screen_ararm_cancel_imgbtn_label = lv_label_create(ui->main_screen_ararm_cancel_imgbtn);
    lv_label_set_text(ui->main_screen_ararm_cancel_imgbtn_label, "");
    lv_label_set_long_mode(ui->main_screen_ararm_cancel_imgbtn_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->main_screen_ararm_cancel_imgbtn_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->main_screen_ararm_cancel_imgbtn, 0, LV_STATE_DEFAULT);
    lv_obj_set_pos(ui->main_screen_ararm_cancel_imgbtn, 275, 5);
    lv_obj_set_size(ui->main_screen_ararm_cancel_imgbtn, 16, 16);

    // Write style for main_screen_ararm_cancel_imgbtn, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_text_color(ui->main_screen_ararm_cancel_imgbtn, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_screen_ararm_cancel_imgbtn, &lv_Font_8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->main_screen_ararm_cancel_imgbtn, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->main_screen_ararm_cancel_imgbtn, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write style for main_screen_ararm_cancel_imgbtn, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
    lv_obj_set_style_img_recolor_opa(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_img_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_text_color(ui->main_screen_ararm_cancel_imgbtn, lv_color_hex(0xFF33FF), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_text_font(ui->main_screen_ararm_cancel_imgbtn, &lv_Font_8, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_text_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_shadow_width(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_PRESSED);

    // Write style for main_screen_ararm_cancel_imgbtn, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
    lv_obj_set_style_img_recolor_opa(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_img_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_color(ui->main_screen_ararm_cancel_imgbtn, lv_color_hex(0xFF33FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_font(ui->main_screen_ararm_cancel_imgbtn, &lv_Font_8, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_text_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_width(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_STATE_CHECKED);

    // Write style for main_screen_ararm_cancel_imgbtn, Part: LV_PART_MAIN, State: LV_IMGBTN_STATE_RELEASED.
    lv_obj_set_style_img_recolor_opa(ui->main_screen_ararm_cancel_imgbtn, 0, LV_PART_MAIN | LV_IMGBTN_STATE_RELEASED);
    lv_obj_set_style_img_opa(ui->main_screen_ararm_cancel_imgbtn, 255, LV_PART_MAIN | LV_IMGBTN_STATE_RELEASED);

    // Write codes main_screen_alarm_img
    ui->main_screen_alarm_img = lv_img_create(ui->main_screen_ararm_cont);
    lv_obj_add_flag(ui->main_screen_alarm_img, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->main_screen_alarm_img, "0:/PICTURE/software_icon/alarm_icon.bin");
    lv_img_set_pivot(ui->main_screen_alarm_img, 50, 50);
    lv_img_set_angle(ui->main_screen_alarm_img, 0);
    lv_obj_set_pos(ui->main_screen_alarm_img, 20, 30);
    lv_obj_set_size(ui->main_screen_alarm_img, 32, 32);

    // Write style for main_screen_alarm_img, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->main_screen_alarm_img, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->main_screen_alarm_img, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->main_screen_alarm_img, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->main_screen_alarm_img, true, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes main_screen_alarm_label
    ui->main_screen_alarm_label = lv_label_create(ui->main_screen_ararm_cont);
    lv_label_set_text(ui->main_screen_alarm_label, "");
    lv_label_set_long_mode(ui->main_screen_alarm_label, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->main_screen_alarm_label, 65, 33);
    lv_obj_set_size(ui->main_screen_alarm_label, 60, 30);

    // Write style for main_screen_alarm_label, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->main_screen_alarm_label, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_screen_alarm_label, &lv_Font_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->main_screen_alarm_label, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->main_screen_alarm_label, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->main_screen_alarm_label, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->main_screen_alarm_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes main_screen_label
    ui->main_screen_buzzer_label = lv_label_create(ui->main_screen_ararm_cont);
    lv_label_set_text(ui->main_screen_buzzer_label, "响铃中");
    lv_label_set_long_mode(ui->main_screen_buzzer_label, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->main_screen_buzzer_label, 135, 37);
    lv_obj_set_size(ui->main_screen_buzzer_label, 100, 20);

    // Write style for main_screen_buzzer_label, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->main_screen_buzzer_label, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_screen_buzzer_label, &lv_Font_10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->main_screen_buzzer_label, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->main_screen_buzzer_label, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->main_screen_buzzer_label, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes main_screen_close_btn
    ui->main_screen_close_btn = lv_btn_create(ui->main_screen_ararm_cont);
    ui->main_screen_close_btn_label = lv_label_create(ui->main_screen_close_btn);
    lv_label_set_text(ui->main_screen_close_btn_label, "关闭");
    ...
    lv_obj_set_pos(ui->main_screen_close_btn, 245, 35);
    lv_obj_set_size(ui->main_screen_close_btn, 40, 20);

    // Write style for main_screen_close_btn, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->main_screen_close_btn, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->main_screen_close_btn, lv_color_hex(0xd0d8de), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->main_screen_close_btn, LV_GRAD_DIR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->main_screen_close_btn, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->main_screen_close_btn, &lv_Font_8, LV_PART_MAIN | LV_STATE_DEFAULT);
